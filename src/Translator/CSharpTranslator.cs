...
namespace Translator
{
    ...
    {
        public CSharpTranslator(IEnumerable<Instruction> instr_list) : base(instr_list)
        {
        }

        public override string[] translate()
        {
            // should add class program and all ...
            return instr2Lines(instr_list);
        }
        ...
        protected override string[] forTr(ForLoop loop)
        {
            ...
            string
                ...
                stop = normalizeExpression(((Expression) info[1]).expr),
